    ...
    <>
      ...
      <Form id="SingUpForm">
        ...
        <div className="item-cont">
          ...
          <samp
            style={verified ? verifstyle : undefined}
            onClick={verifi}
            className="meilverifi"
          >
            {' '}
            <img src={send} alt="" />
          </samp>
        ...
        >
          <div className="pass">
            ...
            <samp className="example">
              <span id="App">A</span>-<span id="Low">a</span>-
              <span id="Num">1</span>-<span id="Sim">!</span>-
        ...
        <div className="item-cont add">
          <button className="singup" onClick={handleSubmit}>
            Register
          </button>
        </div>
      </Form>
